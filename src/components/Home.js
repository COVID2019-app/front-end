			...
			<tbody>
				...
				{country.map(item => (
					<tr>
						...
						<Tabletd> {item.confirmed_cases.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')} </Tabletd>{' '}
						...
						<Tabletd
							style={{
								background: `rgba(255, 0, 0, ${item.deaths / item.confirmed_cases})`,
							}}
						>
						...
						<Tabletd style={{ color: 'green' }}>
							{' '}
							{item.recovered.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}{' '}
						</Tabletd>{' '}
						<Tabletd
							style={{
								background: `rgba(0,128,0, ${item.recovered / item.confirmed_cases})`,
							}}
						>
						...
						<Tabletd style={{ color: 'purple' }}>
							{' '}
							{item.severe_critical.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}{' '}
						</Tabletd>{' '}
						<Tabletd
							style={{
								background: `rgba(128,0,128, ${item.severe_critical / item.confirmed_cases})`,
							}}
						>
						...
						<Tabletd style={{ color: '#e69900' }}>
							{' '}
							{item.active_cases.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}{' '}
						</Tabletd>{' '}
						<Tabletd
							style={{
								background: `rgba(255, 171, 0, ${item.active_cases / item.confirmed_cases})`,
							}}
						>
