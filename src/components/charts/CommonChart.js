...
function CommonChart(props) {
    ...
    const { country_name, field, title, region_sum, isFetching, region_data, region_names} = props
        ...
        if (country_name === "USA") {
            return (
                <React.Fragment>
                    ...
                    <br />
                    <br />
                    <StackedBarChart region_data={region_data} country_name={country_name} field={field} region_names={region_names} title={title} />
                    <br />
                    <br />
                    <SplineChart region_data={region_data} country_name={country_name} field={field} region_names={region_names} title={title} />
                </React.Fragment>
